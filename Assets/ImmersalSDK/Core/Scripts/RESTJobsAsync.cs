...
namespace Immersal.REST
{
    ...
    public class JobCopyMapAsync : JobAsync
    {
        public string login;
        public int id;
        public Action<SDKCopyMapResult> OnResult;
    ...
    public class JobAlignMapsAsync : JobAsync
    {
        public string name;
        public SDKMapId[] mapIds;
        public Action<SDKAlignMapsResult> OnResult;
    ...
    public class JobStitchMapsAsync : JobAsync
    {
        public string name;
        public SDKMapId[] mapIds;
        public Action<SDKStitchMapsResult> OnResult;
